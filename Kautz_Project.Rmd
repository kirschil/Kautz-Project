...
### Appendices, File Download, & Works Cited
...
server <- function(input, output) {
  datasetInput <- reactive({
    switch(input$dataset,
           "MSA Dataset" = msaboostdata,
           "MSA Recession Summary" = msarecessiontotal,
           "State Dataset" = statesdata,
           "State Recession Summary" = statetables)
  })
...
####################################
ui <- fluidPage(
  titlePanel('File Downloader'),
  sidebarLayout(
    sidebarPanel(
      selectInput("dataset", "Choose a dataset:", 
                  choices = c("MSA Dataset", "MSA Recession Summary", "State Dataset", "State Recession Summary")),
...
"Economic Conditions Index by BEA Region." FRED St. Louis, fred.stlouisfed.org/release/tables?rid=343&eid=47873&snid=47887.
